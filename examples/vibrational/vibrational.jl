...
s = System("g")
energy!(s, "a", ω_a - ω_frame + s_hr*ω_vib)  # maintain the 0-phonon line at \omega_a
dipole!(s, "g", "a", 1.0)
lineshape!(s, "a", "a", t->g_homo(t, γ)+g_inhomo(t, σ)+s_hr*g_huang_rhys(t, ω_vib, kt))
